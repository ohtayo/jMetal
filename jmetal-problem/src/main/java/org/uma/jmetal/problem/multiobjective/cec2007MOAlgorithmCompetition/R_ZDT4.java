...
public class R_ZDT4 extends AbstractDoubleProblem {
  ...
  public interface CEC2007TestSuite extends Library {
    ...
    void R_ZDT4(double[] x, double[] f, int nx, int n_obj);
  }
   ...
   */
  public R_ZDT4(Integer numberOfVariables, Integer numberOfObjectives) throws JMetalException {
...
//  Call function using JNA
    ...
    testSuite.R_ZDT4(x, f, numberOfVariables, numberOfObjectives);
