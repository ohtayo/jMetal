...
public class OMOPSODBTIBG extends OMOPSOWithSizeLimitedArchive {
  ...
  /** Constructor */
  public OMOPSODBTIBG(DoubleProblem problem, SolutionListEvaluator<DoubleSolution> evaluator,
  ...
  protected void updateVelocity(List<DoubleSolution> swarm)  {
    ...
    for (int i = 0; i < swarmSize; i++) {
      ...
      // (2)[IBG] 対象particleとarchiveが同一ランクであれば，同一ランクarchiveから近い10個体のうちランダムでvelocityを足し合わせる
        ...
        updateVelocityUsingIndicatorBasedGBest(W, C1, C2, r1, r2, i, particle, sameRankArchive);
      }
