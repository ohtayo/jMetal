...
/**
 * Class implementing the CMA-ES algorithm supports constraints.
 * @author ohtayo <ohta.yoshihiro@outlook.jp>
 */
@SuppressWarnings("serial")
public class ConstraintCovarianceMatrixAdaptationEvolutionStrategy
  ...
  /** Constructor */
  private ConstraintCovarianceMatrixAdaptationEvolutionStrategy(Builder builder) {
  ...
  public static class Builder {
    ...
    public Builder(DoubleProblem problem) {
      ...
      sigma = DEFAULT_SIGMA;
      evaluator = new SequentialSolutionListEvaluator<DoubleSolution>();  // 最初は単スレッドの評価
    }
    ...
    public Builder setEvaluator(SolutionListEvaluator<DoubleSolution> evaluator) {
      this.evaluator = evaluator;
      return this;
    }

    public ConstraintCovarianceMatrixAdaptationEvolutionStrategy build() {
      return new ConstraintCovarianceMatrixAdaptationEvolutionStrategy(this);
    }
  }
