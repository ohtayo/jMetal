...
public class OMOPSORVDBTIBGIBP extends OMOPSORVDBTIBG {

  /** Constructor */
  public OMOPSORVDBTIBGIBP(DoubleProblem problem, SolutionListEvaluator<DoubleSolution> evaluator,
