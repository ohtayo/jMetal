...
public class ParallelOMOPSODBTRunner extends AbstractAlgorithmRunner {
  /**
  ...
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    if (args.length == 1) {
      ...
      problemName = "org.uma.jmetal.problem.multiobjective.ep.ZEBRefModelVarDiff2ObjConPMVCondLSTM";
    ...
    OMOPSOBuilder builder = new OMOPSOBuilder(problem, evaluator)
            ...
            .setVariant(OMOPSOBuilder.OMOPSOVariant.OMOPSODBT);
