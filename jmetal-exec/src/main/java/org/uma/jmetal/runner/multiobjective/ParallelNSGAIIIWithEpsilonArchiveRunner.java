...
import org.uma.jmetal.algorithm.multiobjective.nsgaiii.NSGAIIIWithEpsilonArchive;
 ...
 */
public class ParallelNSGAIIIWithEpsilonArchiveRunner extends AbstractAlgorithmRunner {
  /**
...
//      problemName = "org.uma.jmetal.problem.multiobjective.zdt.ZDT1";
    ...
    if(!StringUtility.isNullOrEmpty(fileNameOfInitialSolutions)) {
      List<DoubleSolution> initialPopulation = ((NSGAIIIWithEpsilonArchive<DoubleSolution>) algorithm).createInitialPopulation();
      ...
      ((NSGAIIIWithEpsilonArchive<DoubleSolution>) algorithm).setInitialPopulation(initialPopulation);
