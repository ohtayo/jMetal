...
public class ParallelOMOPSORVDBTDFGRunner extends AbstractAlgorithmRunner {
  /**
  ...
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    if (args.length == 1) {
      ...
      problemName =  "org.uma.jmetal.problem.multiobjective.UF.C3_UF12MatlabEngineAtOneTimeEvaluation";
    ...
    OMOPSOBuilder builder = new OMOPSOBuilder(problem, evaluator)
            ...
            .setVariant(OMOPSOBuilder.OMOPSOVariant.OMOPSORVDBTDFG);
